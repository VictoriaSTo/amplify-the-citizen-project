...
export default function NavBar(props) {
  ...
  const dashboardOnClick = useNavigateAction({
    type: "url",
    url: "https://main.d3hn7b1glu91c8.amplifyapp.com/",
  });
  const jobsOnClick = useNavigateAction({
    type: "url",
    url: "https://main.d3hn7b1glu91c8.amplifyapp.com/resident",
  });
  const applicantsOnClick = useNavigateAction({
    type: "url",
    url: "https://main.d3hn7b1glu91c8.amplifyapp.com/connect",
  });
  const companyOnClick = useNavigateAction({
    type: "url",
    url: "https://main.d3hn7b1glu91c8.amplifyapp.com/about-us",
  });
  return (
    <Flex
      gap="20px"
